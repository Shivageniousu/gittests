...
$d2 = date_create('29-09-2020 14:20:00.000');
...
<head>
  ...
  <title>VIP Masterclass Series #1 : Generate an additional $25,000 per month in Remote Sales</title>
...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700" rel="stylesheet">
 ...
 <meta property="og:title"
    content="VIP Masterclass Series #3 : Digital Marketing Trends during crisis and beyond" />
  <meta property="og:description"
    content="Discover 3 Digital Strategies that have generated $3 Million+ for Genius Group this year and how you can replicate it for your business." />
...
<div class="b2g">
   <div class="row  rowm "  data-equalizer>
      ...
      <div class="medium-9 rown   large-5 medium-push-3 large-push-7 rown columns  "  data-equalizer-watch>
          ...
          <h4 class=" white"><b>VIP Masterclass Series #3:</b><br><b class="grntxt">Digital Marketing Trends during crisis and beyond </b></h4>

          <p class="white">Discover 3 Digital Strategies that have generated $3 Million+ for Genius Group this year and how you can replicate it for your business.</p>

<p class="white"><span class="grntxt"><b> Webinar on Tuesday, 29th
            September 2020   </b></span><br/>
 </p>
            <center>
...
<div class="fixed">
      ...
      <div class="top-bar-left">
        <ul class="menu vertical">
          <li>
           ...
           <p class="smlp" style="color: #000"><a href="https://solutions.geniusu.com/masterclass/remote/webinar/asia/live/?sfid=<?php echo($sfid);?>" style="color: inherit;"><b>Masterclass One </b><br/> Generate an additional $25,000 per month in Remote Sales</a></p> 
          </li>
          <li>
             <p class="smlp" style="color: #000"><a href="https://solutions.geniusu.com/masterclass/leadership/webinar/asia/live/?sfid=<?php echo($sfid);?>" style="color: inherit;"><b>Masterclass Two </b><br/> Decisive Leadership: How to shift you and your team from uncertainty to growth mode.</a></p> 
          </li>
          <li>
            <a disabled>
  ...
  <div style="background: #15264C" >  <!-- class="sticky" id="top_nv" data-sticky data-sticky-on="small" data-margin-top="0"> -->
          ...
          <center>
            <div class="row medium-up-4">
              <div class="columns">
                ...
                <a href="https://solutions.geniusu.com/masterclass/remote/webinar/asia/live/?sfid=<?php echo($sfid);?>" style="color: inherit;">
              ...
              <div class="columns">
                ...
                <div class="btn25 max_m">
                  <a href="https://solutions.geniusu.com/masterclass/leadership/webinar/asia/live/?sfid=<?php echo($sfid);?>" style="color: inherit;">
                 <img src="img/n2.jpg">
   ...
   <div class="row rown " style="max-width: 70em;" >
    ...
    <center>
  <h3 class="grntxt"><b>Genius Solutions 2020 VIP Masterclass&nbsp;Series</b></h3>
...
<div style="background: #ECECEC;">
  <div class="row rown">
    <div class="small-12  medium-centered  columns">
      <h2 class="grntxt center rowl"><b>Apply here to book your Genius Solutions Complimentary Business Activation Session</b></h2>
...
$("#form_data").submit(function(e) {
   ...
   // $('#form_sub').attr('disabled');
    ...
    //       });
          ...
          $.ajax({
            type: 'post',
            url: 'https://solutions.geniusu.com/masterclass/digital/webinar/asia/live/sf/sfsubscribe-reg2.php',
            data: $('form').serialize(),
            // async: true,
             success: function (data) {
        console.log(data);
...
$.ajax({
            type: 'post',
            url: 'https://solutions.geniusu.com/masterclass/digital/webinar/asia/live/sf/sfsubscribe-webinar-attended.php',
            data: "id="+data1,
            // async: true,
           success: function (data) {
        console.log(data);
...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>VIP Masterclass Series #3 : Digital Marketing Trends during crisis and beyond</title>
...
<div class="b2g">
 ...
 <div class="medium-9 medium-centered  large-6 large-push-3 rown columns  text-center" data-equalizer-watch>
      ...
      <h4><b class="white">VIP Masterclass Series #3:</b><br><b class="grntxt">Digital Marketing Trends during crisis and beyond</b></h4>
        ...
        <center>
<a href=<?php echo "https://calendar.google.com/calendar/r/eventedit?text=VIP+Masterclass+Series+%233:+Digital+Marketing+Trends+during+crisis+and+beyond&dates=20200929T080000Z/20200929T093000Z&details=For+details,+link+here:+https://solutions.geniusu.com/masterclass/digital/webinar/asia/live/?sfid=".$sfid."&location=https://solutions.geniusu.com/masterclass/digital/webinar/asia/live/?sfid=".$sfid; ?>
...
{
  header('Location: https://solutions.geniusu.com/masterclass/digital/webinar/asia/');
}
?>
